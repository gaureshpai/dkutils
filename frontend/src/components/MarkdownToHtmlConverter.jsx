	...
	return (
		<div className="container mx-auto p-4">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				<div>
					<label htmlFor="markdownInput" className="block mb-2 text-sm font-medium text-foreground">
						Markdown Input
					</label>
					<textarea
						id="markdownInput"
				...
				<div>
					<div className="flex items-center justify-between mb-2">
						<label htmlFor="htmlOutput" className="block text-sm font-medium text-foreground">
							HTML Output
						</label>
						<button
							type="button"
