...
const PdfPageDeleter = () => {
	...
	return (
		<div className="container mx-auto p-4">
			...
			<div className="mb-4">
				<label className="block mb-2 text-sm font-medium text-foreground" htmlFor="pdfUpload">
					Upload PDF:
				</label>
				<input
					type="file"
			...
			{pdfFile && numPages > 0 && (
				<div className="mb-4">
					...
					<label className="block mb-2 text-sm font-medium text-foreground" htmlFor="pagesToDelete">
