...
const INITIAL_TOOLS = [
	{
		...
		description: "Convert text to various case formats (e.g., uppercase, lowercase, title case).",
	...
	},
	{
		...
		description: "Generate various cryptographic hashes (e.g., MD5, SHA1, SHA256).",
