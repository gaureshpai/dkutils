	...
	const categories = [
		{
			...
			link: "/images",
			tools: ["Image Converter", "Compressor", "Resizer", "Cropper", "BG Remover", "Grayscaler"],
		},
		{
			title: "PDF Tools",
	...
	return (
		<>
			<Helmet>
				...
				<meta
					name="description"
					content="dkutils provides a comprehensive suite of free online tools for image optimization, PDF manipulation, text conversion, and web tasks. Quickly remove image backgrounds, convert formats, and boost productivity."
				/>
				<meta
					name="keywords"
					content="dkutils, online tools, image tools, background remover, remove bg, transparent background, PDF tools, text tools, web tools, converter, compressor, resizer"
				/>
				<meta property="og:title" content="dkutils - Your One-Stop Solution for Everyday Tools" />
				<meta
			...
			<section className="relative overflow-hidden pt-8 pb-12 md:pt-20 md:pb-32 lg:pt-32 lg:pb-40">
				...
				<div className="absolute inset-x-0 -top-20 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
					<div className="relative left-[calc(50%-11rem)] aspect-1155/678 w-578 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%-30rem)] sm:w-1155 dark:from-[#3b82f6] dark:to-[#14b8a6]" />
				</div>
				...
				<div className="container px-4 md:px-6 flex max-w-5xl flex-col items-center gap-6 md:gap-10 text-center mx-auto">
					<div className="inline-flex items-center rounded-full border border-chart-2/20 bg-chart-2/10 px-3 py-1 text-sm font-medium text-chart-2 backdrop-blur-md ">
						<span className="mr-2 flex h-2 w-2 rounded-full animate-pulse bg-chart-2/100" />
					...
					<p className="max-w-2xl leading-normal text-muted-foreground sm:text-xl sm:leading-8">
						Convert, compress, edit, and analyze images, PDFs, text, and web resources instantly. No
						server uploads for most tools - secure, fast, and free.
					</p>
				...
				<div className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
					<div className="relative left-[calc(50%+3rem)] aspect-1155/678 w-578 -translate-x-1/2 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%+36rem)] sm:w-1155 dark:from-[#3b82f6] dark:to-[#14b8a6]" />
				</div>
			</section>
			...
			<section className="container space-y-6 bg-muted/30 py-8 dark:bg-transparent md:py-12 lg:py-24 max-w-7xl mx-auto px-4 md:px-6 rounded-3xl">
				<div className="mx-auto flex max-w-4xl flex-col items-center space-y-4 text-center">
					...
					<p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
						From developers to designers, students to professionals, we have the tools you need to
						get the job done.
					</p>
							...
							<div className="flex flex-col justify-between h-full">
								...
								<div className="flex flex-wrap gap-1 mb-4">
									{category.tools.slice(0, 4).map((tool) => (
										<Badge key={tool} variant="secondary" className="text-[10px] px-1 py-0">
											{tool}
										</Badge>
									))}
			...
			<section className="container py-12 md:py-24 max-w-7xl mx-auto border-t px-4 md:px-6">
				<div className="mx-auto flex max-w-4xl flex-col items-center justify-center gap-4 text-center mb-12">
					...
					<p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
						dkutils is powered by the latest web technologies to ensure speed, security, and
						reliability.
					</p>
				</div>
				<div className="mx-auto grid justify-center gap-6 sm:grid-cols-1 md:grid-cols-3 md:max-w-5xl">
					<Card className="flex flex-col items-center text-center p-6 hover:shadow-md transition-shadow">
						...
						<CardContent className="p-0">
							...
							<CardDescription>
								Built on a blazing fast React frontend powered by Vite for instant load times and
								smooth interactions.
							</CardDescription>
						</CardContent>
					</Card>
					...
					<Card className="flex flex-col items-center text-center p-6 hover:shadow-md transition-shadow">
						...
						<CardContent className="p-0">
							...
							<CardDescription>
								Beautiful, accessible, and responsive UI components styled with Tailwind CSS for a
								modern look.
							</CardDescription>
						</CardContent>
					</Card>
					...
					<Card className="flex flex-col items-center text-center p-6 hover:shadow-md transition-shadow">
						...
						<CardContent className="p-0">
							...
							<CardDescription>
								We prioritize your privacy. Many tools process files locally in your browser,
